    ...
    <script>
        window.onload = function () {
            ...
            oSwitch_login.onclick = function () {
                ...
                oSwitch_regist.style.color = '#999999';
...
<body style="background:url(${pageContext.request.contextPath}/images/gds.jpg) no-repeat;">
<div class="container">
        ...
        <div class="qlogin" id="qlogin">
            <div class="web_login" align="center">
                <form action="${pageContext.request.contextPath}/login.action" method="post"
                    ...
                    <font style="color:rgba(255,0,0,0);font-size:16px;">${msg}</font>
